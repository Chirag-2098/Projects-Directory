	...
	?>
				...
				<div class="row">
					<div class="col-md-12 right-chat-textbox">
						...
						<button class="btn" name="mera-submit"><i class="fa fa-telegram" aria-hidden="true"></i>
						</button>
						</form>
		...
		if(isset($_POST['mera-submit'])){
			...
			if($msg == ""){
				...
				<div class='alert alert-danger'>
				  ...
				  <script>alert('Message was unable to send!')</script>
				...
				<div class='alert alert-danger'>
				  ...
				  <script>alert('Message is Too long! Use only 100 characters')</script>
